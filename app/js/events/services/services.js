...
services.factory('eventService', function(calendarAppConfig){
    ...
    factory.create = function(event,operatingDate,storedData){
        ...
        var update = JSON.stringify(EventData);
        localStorage.setItem(EventsDB, update);
        return update ;
    };

    factory.remove = function(event,key,storedEvents){
